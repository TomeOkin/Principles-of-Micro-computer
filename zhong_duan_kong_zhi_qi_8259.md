...
题目：  
 ...
 设8086系统中采用单片8259A，其8259A的ICW2=32H，则对应IR5的中断类型号为35H，它的中断入口地址在中断向量表中的地址为D4H。  
  
5.在中断方式下，外设数据输入到内存的路径是外设→I∕O接口→CPU→内存。  

6.多片8259A级联时，主片8259A的CAS2~CAS0应连至从片8259A的CS2~CS0引脚；从片8259A的INT应连至主片8259A的IR引脚；主片8259A的INT应连至CPU的INTR引脚。对于主8259A，级联信号CAS0-CAS2是输出信号，对于从8259A级联信号CAS0-CAS2是输入信号。（P244最下面）  
